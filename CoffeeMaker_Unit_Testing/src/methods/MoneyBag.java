...
// constructors: empty, array, two Monies, Money and MoneyBag, two MoneyBags
public class MoneyBag implements IMoney {
	...
	// returns a new MoneyBag that with added money m to this bag
	...
	// iterates through input MoneyBag and appends to bag
	...
	// This method adds money to fMonies, which is our money bag. searching for existing currency - if exists: remove old, sum and add, if doesnt: add
